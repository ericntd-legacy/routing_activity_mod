    ...
    implements ConversationFragment.ConversationFragmentListener
{
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (id==R.id.menu_call) {
    	handleDial(getRecipients().getPrimaryRecipient()); return true;
    } else if (id==R.id.menu_delete_thread) {
    	handleDeleteThread();                              return true;
    } else if (id==R.id.menu_add_attachment) {
    	handleAddAttachment();                             return true;
    } else if (id==R.id.menu_start_secure_session) {
    	handleStartSecureSession();                        return true;
    } else if (id==R.id.menu_abort_session) {
    	handleAbortSecureSession();                        return true;
    } else if (id==R.id.menu_verify_recipient) {
    	handleVerifyRecipient();                           return true;
    } else if (id==R.id.menu_verify_session) {
    	handleVerifySession();                             return true;
    } else if (id==R.id.menu_group_recipients) {
    	handleDisplayGroupRecipients();                    return true;
    } else if (id==R.id.menu_distribution_broadcast) {
    	handleDistributionBroadcastEnabled(item);          return true;
    } else if (id==R.id.menu_distribution_conversation) {
    	handleDistributionConversationEnabled(item);       return true;
    } else if (id==android.R.id.home) {
    	handleReturnToConversationList();                  return true;
    }
  ...
  public boolean onContextItemSelected(android.view.MenuItem item) {
    ...
    int id = item.getItemId();
    if (id==R.id.menu_context_send_unencrypted) {
    	sendMessage(true); return true;
    }
